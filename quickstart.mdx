...
Assign Engine tasks by adding Engine's label to an issue.

Find this label in the blue pill on the relevant repo on the 'repositories' page. Click on the label to copy it, and add it to the task you would like Engine to work on.