...
Depending on your integration, you may need to connect a team or board to a repo. You can do this from the repositories page in the Engine app. This tells Engine what to monitor for assigned issues. You can assign multiple repos to the same board or team.
