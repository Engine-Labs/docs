...
You can allow access to all repos or only specific repos during the auth flow. If you want to update these permissiong later navigate to the Engine Labs application in your git provider's settings.
...
This can take 2-30 minutes depending on the size and compleixity of your repo.
