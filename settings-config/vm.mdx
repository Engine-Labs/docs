...
cto.new will automatically resize your VM's memory to meet the needs of your project in increments of 2Gb from 4Gb to a maximum of 16Gb. Users that require more than 16Gb of memory should [contact us](/help/support).
...
Live preview requires build and run steps. These must run successfully for the app to be runnable in live preview.

### Task Runner Test

Run a test to verify your task runner is configured properly and cto.new can successfuly make commits.
