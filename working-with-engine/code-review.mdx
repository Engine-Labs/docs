...
title: "Pull Requests"
icon: "code-branch"
description: "Triggering engine from a PR"
---

Engine can re-start work on its own PRs or help out on PRs from other users.
...
Closing a PR in Github will update its status in Engine.