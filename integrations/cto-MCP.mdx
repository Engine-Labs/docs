---
title: "cto.new MCP Server"
icon: "satellite-dish"
description: "Connect to cto.new from other tools via MCP"
---
...
Our MCP server is remote only. You may like to try something like [this](https://github.com/geelen/mcp-remote) to use it locally. 