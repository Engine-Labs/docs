...
<AccordionGroup>
  ...
  <Accordion title=" Start with small tasks" icon="arrow-up-big-small">
    ...
    You'll soon get used to working with [cto.new](http://cto.new) and planning bigger tasks.
  </Accordion>
...
**<Icon icon="calendar-lines-pen" size={18} /> Keep it short and to the point**

Try to exclude irrelevant context. Pasting in long AI generated task descriptions often doesn't help.

<Icon icon="arrow-down-left" size={18} /> **Be specific**
...
<Icon icon="file-waveform" size={18} /> **Tests?**

Let cto.new know what your testing requirements are for a particular task, or any other success criteria you have.

<Icon icon="question" size={18} /> **Avoid vague tasks**

cto.new will attempt to complete vague or poorly defined tasks, but the outcome is unlikely to be what you had in mind.
